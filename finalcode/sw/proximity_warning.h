...
#define RPM_IDLE_THR            5
#define RPM_MOVE_THR            90

// Steering thresholds (Q16.16 metres)
#define STEER_SOFT_THR          10000   // 0.30 m
#define STEER_HARD_THR          52428   // 0.80 m

// Lane-change durations (in milliseconds, converted from 100 MHz clocks)
